...
class DenseSpatialCL(nn.Module):
    '''DenseCL.
    ...
    def __init__(self,
                 ...
                 nei_k = 4096,
                 **kwargs):
        super(DenseSpatialCL, self).__init__()
    ...
    def forward_train(self, img, idx, bag_idx, x_coord, y_coord, **kwargs):
        ...
        with torch.no_grad():  # no gradient to keys
            ...
            k_b = k_b[0]
            k_b_pool = self.pool(k_b).view(k_b.size(0), -1)
            ...
            k_b_pool = nn.functional.normalize(k_b_pool, dim=1)
            ...
            k_b_pool = self._batch_unshuffle_ddp(k_b_pool, idx_unshuffle)
        ...
        with torch.no_grad():
            ...
            self.memory_bank_b.update(idx, k_b_pool.detach())
        with torch.no_grad():
            # renew self.cluster
