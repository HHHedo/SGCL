...
class SpatialMoco(nn.Module):
    ...
    def __init__(self,
                 ...
                 nei_k = 4096,
                 **kwargs):
        super(SpatialMoco, self).__init__()
    ...
    #     # _, semantric_pos_idx = self._simi_ir(s_all, q, idx, spatial_pos_idx) # (batch_size, ndata), similarity
    #     # - hard mining
    #     s_whole  = self._hard_mining(d_all, q, idx, spatial_pos_idx, semantric_pos_idx) #(bs , k=4096), similarity
    #     # s_molecular, s_denominator = self._hard_mining(d_all, q, idx, spatial_pos_idx, semantric_pos_idx) #(bs , k=4096), similarity
    #     # InfoNCE
    ...
    #         print('epoch:{}, semantic weight{:.3f}:'.format(kwargs['epoch'], semnetic_weight))
        ...
        # losses['loss_contra_spatial'] = loss_spatial * semnetic_weight * 0.5
