...
class SpatialCLJigsaw(nn.Module):
    '''SpatialCL.
    ...
    def __init__(self,
                ...
                #  temperature=0.07,
                 ...
                 nei_k = 4096,
                 **kwargs):
        super(SpatialCLJigsaw, self).__init__()
    ...
    def forward_train(self, img, img2, repeat_idx, idx, bag_idx, x_coord, y_coord, **kwargs):
        ...
        with torch.no_grad():
            ...
            if kwargs['iter']%50==0 and torch.distributed.get_rank() == 0 and self.similar:
                ...
                print('Spatial：{:.0f} {:.3f}+-{:.3f}--Sum={:.3f}   Sementics:{:.0f} {:.3f}+-{:.3f}--Sum{:.3f}   IR:{:.3f}+-{:.3f}/{:.3f}+-{:.3f}    Jig:{:.3f}+-{:.3f}/{:.3f}+-{:.3f}'
                ...
                jig_m_p ,jig_v_p, jig_m_n ,jig_v_n))
