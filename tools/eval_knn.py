...
def extract_feature_pipeline(args):
    ...
    dataset_train = Camelyon(
                            list_file='data/camelyon/meta/train_selected.txt',
                            root= '/remote-home/share/DATA/CAMELYON16/DATA/train', 
                            transform=transform)
    dataset_val = Camelyon(
                            list_file='data/camelyon/meta/val_linear_cls.txt',
                            root= 'data/camelyon/val', 
                            transform=transform)
    ...
    train_labels = torch.tensor([s for s in dataset_train.labels]).long()
    test_labels = torch.tensor([s for s in dataset_val.labels]).long()
