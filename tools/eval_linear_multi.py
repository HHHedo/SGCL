...
def eval_linear(args):
    ...
    dataset_train = Camelyon(
                            list_file='data/camelyon/meta/train_linear_cls.txt',
                            root= '/remote-home/ltc/DenseCL/data/camelyon/train', 
                            transform=train_transform,
                            database=args.database,)
    dataset_val = Camelyon(
                            list_file='data/camelyon/meta/val_linear_cls.txt',
                            root= '/remote-home/ltc/DenseCL/data/camelyon/val', 
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if epoch % args.val_freq == 0 or epoch == args.epochs - 1:
            ...
            test_stats, buffer_dict = validate_network(val_loader, model, linear_classifiers, args.permutes)
            ...
            group_best_auc_sweep_lr_only = 0
            # auc_list=[]
